      ...
      <div id="stars">
        <div id="container">
          ...
          <?php require "menu.php"; ?>
            ...
            <nav id="secondary">
              <ul>
                <li class="current"><a href="#maintab">Editar Fechamento</a></li>
              </ul>
            </nav>
            ...
            <section id="content">
              ...
              <div class="tab" id="maintab">
                <h2>Editando o fechamento de: <?php echo "$folha->mes/$folha->ano"; ?> </h2> 
              ...
              <form id="fechamento" method="post">
                ...
                <table>
                	...
                	<tbody class="increase">
                		<?php
                			$sql = "SELECT funcionario.cod_funcionario AS id, funcionario.nome, folhadeponto.* FROM funcionario, folhadeponto WHERE folhadeponto.cod_funcionario = funcionario.cod_funcionario";
                			$q = $fponto->bd->qry($sql);
                		...
                		<tr>
                			<td>
                				...
                				<input type="hidden" name="mes" value="<?php echo $fp->mes ?>" />
              					<input type="hidden" name="ano" value="<?php echo $fp->ano ?>" />
                			</td>
                			<?php $i++; ?>
                			<td><input type="text" tabindex="<?php echo $i; ?>" name="faltas" value="<?php echo $fp->faltas ?>" /></td>
                			<?php $i++; ?>
                			<td><input type="text" tabindex="<?php echo $i; ?>" name="dsr" value="<?php echo $fp->dsr ?>" /></td>
                			<?php $i++; ?>
                			<td><input type="text" tabindex="<?php echo $i; ?>" name="he60" value="<?php echo $fp->he60 ?>" /></td>
                			<?php $i++; ?>
                			<td><input type="text" tabindex="<?php echo $i; ?>" name="he100" value="<?php echo $fp->he100 ?>" /></td>
                			<?php $i++; ?>
                			<td><input type="text" tabindex="<?php echo $i; ?>" name="feriados" value="<?php echo $fp->feriado ?>" /></td>
                		</tr>
                		<?php
                			$i++;
                			endwhile;
...
<div class="clear"></div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			{
				$.post("ajax_editarfolhadeponto.php", data );
				// console.log(data);
			}
